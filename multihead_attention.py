    ...
    def forward(
        ...
        if (
            ...
            if not self._attention_mechanism_logged:
                print("🚀 Using FlashAttention varlen (packed sequences with proper boundaries)")
                self._attention_mechanism_logged = True
            ...
            if not self._attention_mechanism_logged and seq_boundaries is not None:
                ...
                print(f"⚠️  FlashAttention NOT used. Failed conditions: {failed}")
                self._attention_mechanism_logged = True
        ...
        if (
            ...
            if not self._attention_mechanism_logged:
                print("⚡ Using PyTorch native multi_head_attention_forward")
                self._attention_mechanism_logged = True
        ...
        if not self._attention_mechanism_logged:
            if self.rot_emb:
                print("🔄 Using custom attention with Rotary Position Embeddings (RoPE)")
            else:
